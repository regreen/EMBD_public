...
date = '20230316T133527'
# date = '20220901T141310'
# >>>>>>> Stashed changes
...
def getAllEmb(folder):
    ...
    for well in range(nWells):
        print("well={}".format(well+1))
        for j in range(pointVisits):
# <<<<<<< Updated upstream
#             if debug:
#                 well, j = 2, 3  # well, field
#                 print('debugging well {0} point {1}'.format(well + 1, j + 1))
...
#-----------------------------------------------------------------------------------------------------------------------------------------------#
            if debug:
                well, j = 2, 3 #set this based on error
                strain = 'GLS' #set this based on error
            imgs = loadImages(folder, well+1, j+1)
            if imgs.size>0:
                print('loaded well {0} point {1}'.format(well+1, j+1))
                if debug:
                    ...
                    strain = strains[well]
                if strain=='MS': featureList = [201,201,None]
